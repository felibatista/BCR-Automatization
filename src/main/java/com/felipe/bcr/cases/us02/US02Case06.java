...
Caso 6 (Positivo):
    ...
    Pasos:
    Hacer click en el botón “Ingresar” de la parte superior de la pantalla.
    En el formulario abierto escribir el “Email” en la sección de “Email, teléfono o usuario”
    Realizar el Captcha en caso de ser solicitado.
    Hacer click en el botón de “Continuar” para seguir el proceso.
