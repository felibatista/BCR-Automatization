...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        US04Case01.run();
        Case case1 = Case.getCaseByUserStoryAndID(UserStory.US04, 1);
        case1.end();
        System.out.println("Case 1 finished. Status: " + case1.getStatus() + " - Time elapsed: " + case1.getFormatTimeElapsed());
